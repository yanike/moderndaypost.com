...
if ( class_exists( 'WP_Customize_Control' ) ) {
     ...
     * @access public
     */
    class Ultra_Seven_Customize_Switch_Control extends WP_Customize_Control {
	 ...
	 */
	class Ultra_Seven_Customize_Help_Control extends WP_Customize_Control {
		public function render_content() {
			?>
			<div class="tmp-help-info">
				<h4><?php esc_html_e( 'Instruction', 'ultra-seven' ); ?></h4>
	...
	class Ultra_Seven_Customize_Radioimage_Control extends WP_Customize_Control {
	...
	class Ultra_Seven_Customize_Seperator_Control extends WP_Customize_Control {
	    public function render_content() { ?>
...
if( class_exists('WP_Customize_Section')){
     ...
     * @access public
     */
    class Ultra_Seven_Customize_Section_Pro extends WP_Customize_Section {
