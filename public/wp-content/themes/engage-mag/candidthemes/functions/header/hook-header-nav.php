...
if (!function_exists('engage_mag_construct_main_navigation')) {
    /**
     * Add main navigation on header
     *
     * @since 1.0.0
     */
    function engage_mag_construct_main_navigation()
    {
        ...
        ?>
        <div class="engage-mag-menu-container <?php echo $sticky_header_class; ?>">
            <div class="container-inner clearfix">
                <nav id="site-navigation"
                     class="main-navigation" <?php engage_mag_do_microdata('navigation'); ?>>
...
add_action('engage_mag_main_navigation', 'engage_mag_construct_main_navigation', 10);
add_action('engage_mag_main_header_one', 'engage_mag_construct_main_navigation', 10);