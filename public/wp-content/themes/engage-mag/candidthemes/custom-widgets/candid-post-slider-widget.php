<?php
/**
 * Engage Mag Post Slider Widget
 *
 * @since 1.0.0
 */
if (!class_exists('Engage_Mag_Post_Slider')) :
     ...
     * @since 1.0.0
     */
    class Engage_Mag_Post_Slider extends WP_Widget
    {
       private function defaults()
       {
        $defaults = array(
            'title'    => esc_html__( 'Posts Slider', 'engage-mag' ),
            'cat'     => 0,
            'post-number' => 5,
            'post-date'=> 1,
            'show-category'=> 1,
    ...
    {
        $opts = array(
            'classname' => 'engage-mag-post-slider',
            'description' => esc_html__('Display post in Slider Form. Suitable on Sidebars.', 'engage-mag'),
        );

        parent::__construct('engage-mag-post-slider', esc_html__('Engage Mag Post Slider', 'engage-mag'), $opts);
    }
        ...
        <div class="engage-mag-slider-container">
            <section class="section-slider">
                <div class="header-carousel">
                    <ul class="ct-post-carousel slider"  data-slick='<?php echo $engage_mag_slider_args_encoded; ?>'>
                        <?php
                        while ($query->have_posts()) : $query->the_post();
                            ...
                            <li>
                                ...
                                if (has_post_thumbnail()) {
                                    ...
                                    $featured_image = esc_url(get_template_directory_uri()) . '/candidthemes/assets/images/refined-mag-carousel-large.jpg';
                                }
                                ?>
