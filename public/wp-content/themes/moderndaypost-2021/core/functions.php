...
if (!function_exists('magazinenp_posted_on')) :
	...
	function magazinenp_posted_on($mnp_post_from = '')
	{
		...
		$byline = '<a href="' . esc_url(get_author_posts_url(get_the_author_meta('ID'))) . '"><i class="mnp-icon fa fa-user-circle"></i>' . esc_html(get_the_author_meta('first_name'). ' ' .get_the_author_meta('last_name')) . '</a> ';
